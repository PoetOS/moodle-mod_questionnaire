...
$perpage = optional_param('perpage', questionnaire::default_page_count(), PARAM_INT);  // How many per page.
...
if (!$nonrespondents) {
    ...
    $page->add_to_page(
        ...
        html_writer::start_tag(
            ...
            [
                'class' => 'mform',
                'action' => 'show_nonrespondents.php',
                'method' => 'post',
                'id' => 'questionnaire_sendmessageform',
            ]
        )
    );
    ...
    if (has_capability('mod/questionnaire:message', $context)) {
        ...
        $editor->use_editor($id, \mod_questionnaire\form_options::editor($context));
