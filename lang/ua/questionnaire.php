...
$string['action'] = 'Дія';
$string['activityoverview'] = 'Є анкети, які мають термін виконання';
$string['additionalinfo'] = 'Додаткова інформація';
$string['additionalinfo_help'] = 'Текст, який буде відображатися у верхній частині першої сторінки анкету. (тобто інструкції, фонову інформацію та інше)';
$string['addnewquestion'] = 'Додавання {$a} питання';
$string['addnewsection'] = 'Додати секцію';
$string['addquestion'] = 'Додавання питання...';
$string['addquestions'] = 'Додати питання';
$string['addquestiontosection'] = 'Додати запитання до розділу';
$string['addselqtype'] = 'Додати вибраний тип питання';
$string['alignment'] = 'Вирівнювання кнопок';
$string['alignment_help'] = 'Виберіть вирівнювання кнопок: вертикальний (за замовчуванням) або горизонтальний.';
