...
#  Scenario: Student completes feedback questions.
    ...
    And I click on "Row 2, Cheese: Column 4, Three." "radio"
    And I click on "Row 3, Bread: Column 4, Three." "radio"
    And I click on "Row 4, Meat: Column 4, Three." "radio"
    And I click on "Row 5, Fruit: Column 4, Three." "radio"
    And I click on "Yes" "radio"
    And I click on "Row 2, Clubs: Column 3, Two." "radio"
    And I click on "Row 3, Diamonds: Column 4, Four." "radio"
    And I click on "Row 4, Hearts: Column 2, Zero." "radio"
    And I click on "Row 5, Spades: Column 6, Sixteen." "radio"
...
#  Scenario: Another student completes feedback questions differently.
    ...
    And I click on "Row 2, Cheese: Column 3, Two." "radio"
    And I click on "Row 3, Bread: Column 3, Two." "radio"
    And I click on "Row 4, Meat: Column 3, Two." "radio"
    And I click on "Row 5, Fruit: Column 3, Two." "radio"
    And I click on "Yes" "radio"
    And I click on "Row 2, Clubs: Column 2, Zero." "radio"
    And I click on "Row 3, Diamonds: Column 3, Two." "radio"
    And I click on "Row 4, Hearts: Column 4, Four." "radio"
    And I click on "Row 5, Spades: Column 5, Eight." "radio"
    And I press "Submit questionnaire"
    Then I should see "Thank you for completing this Questionnaire."
    And I press "Continue"
    And I should see "These are the main Feedback notes"
