...
/**
 * Test csv export of questionnaire.
 * @author    Guy Thomas
...
/**
 * CSV export test for questionnaire module.
 * @author     Guy Thomas
 * @copyright Copyright (c) 2015 Moodlerooms Inc. (http://www.moodlerooms.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
...
/**
 * Unit tests for {@link questionnaire_csvexport_test}.
...
class csvexport_test extends advanced_testcase {
    ...
    public function test_csvexport() {
        ...
        foreach ($questionnaires as $questionnaire) {
            ...
            $csvoutput = $this->get_csv_text($questionnaireinst->generate_csv('', '', 0, 0, 0));
// print_object($csvoutput);
            $this->assertEquals($qdg->expected_csv_output(), $csvoutput);
        }
    }
