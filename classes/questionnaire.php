...
class questionnaire {
    ...
    /**
     * Transitional shim for survey_print_render and view_response: delegate to the
     * renderer's print_survey_start. Removed when those render paths move out in
     * Phase 47b.
     *
     ...
     */
    public function response_goto_saved($url) {
        global $CFG, $USER;
     ...
     * @return bool
     */
    public function has_required($section = 0) {
     ...
     * @return int
     */
    public function response_select_max_sec($rid) {
        global $DB;
