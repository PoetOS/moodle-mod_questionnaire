...
class feedback_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->setDefault('feedbacksections', $questionnaire->feedback()->mode());
        ...
        if (get_config('questionnaire', 'usergraph')) {
            ...
            if ($questionnaire->feedback()->mode() == 1) {
                $mform->setDefault('chart_type_global', $questionnaire->feedback()->chart_type());
            }
            ...
            if ($questionnaire->feedback()->mode() > 1) {
                $mform->setDefault('chart_type_two_sections', $questionnaire->feedback()->chart_type());
            }
            ...
            if ($questionnaire->feedback()->mode() > 1) {
                $mform->setDefault('chart_type_sections', $questionnaire->feedback()->chart_type());
            }
