...
class reporter {
    ...
    public function response_analysis(
        ...
        $scoreboard = $this->questionnaire->feedback()->build_scoreboard(
            $rid,
            $resps,
            $compare,
            $isgroupmember,
        ...
        if ($scoreboard->table !== null) {
            $this->page->add_to_page('feedbackscores', $scoreboard->table);
        }
        if ($scoreboard->chart !== null) {
            $this->page->add_to_page('feedbackcharts', $scoreboard->chart);
        }
        return $scoreboard->messages;
    }
