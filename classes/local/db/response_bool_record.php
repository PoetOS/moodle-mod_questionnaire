...
/**
 * Persistent record for the questionnaire_response_bool table.
 *
 * Stores yes/no answers. The choiceid column holds 'y' or 'n'.
 *
...
class response_bool_record extends \core\persistent {
    ...
    /**
     * Return all bool answers for a given response.
     *
     * @param int $responseid
     * @return response_bool_record[]
     */
