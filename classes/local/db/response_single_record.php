...
/**
 * Persistent record for the questionnaire_resp_single table.
 *
 * Stores the single selected choice for a radio-button question.
 *
...
class response_single_record extends \core\persistent {
    ...
    /**
     * Return all single-choice answers for a given response.
     *
     * @param int $responseid
     * @return response_single_record[]
     */
