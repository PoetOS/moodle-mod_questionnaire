...
use html_writer;
use html_table;
use mod_questionnaire\local\db\bulk_sql_config;
...
abstract class responsetype {
     ...
     */
    public function __construct(\mod_questionnaire\local\question\question $question, ?int $responseid = null, ?array $choices = []) {
