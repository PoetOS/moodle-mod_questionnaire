...
$userview = optional_param('responsestats', 'y', PARAM_ALPHANUM);
...
// Set default userview to full submissions.
$userview = array_key_exists($userview, $responsestatus) ? $userview : 'y';
        ...
        if ($outputtarget == 'pdf') {
            ...
            if ($outputtarget != 'print') {
                ...
                $link = new moodle_url('/mod/questionnaire/report.php',
                    ['action' => 'vall', 'instance' => $instance, 'group' => $currentgroupid, 'target' => 'pdf', 'responsestats' => $userview]);
                ...
                $link = new \moodle_url('/mod/questionnaire/report.php',
                    ['action' => 'vall', 'instance' => $instance, 'group' => $currentgroupid, 'target' => 'print', 'responsestats' => $userview]);
