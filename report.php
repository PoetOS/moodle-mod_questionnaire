...
switch ($action) {
    ...
    case 'dfs':
        ...
        $choicecodesorvalues = optional_param('choicecodesorvalues', '0', PARAM_INT);
        ...
        $output = $questionnaire->generate_csv($currentgroupid, '', $user, $choicecodesorvalues, $choicetext, $showincompletes,
            $rankaverages);
